...
//   const { firstName, lastName, email, password, confirmPassword } = formData
  ...
  return (
    ...
    <form onSubmit={handlePassword}>
        <div className=' bg-zinc-100 p-7 rounded-lg flex gap-7 flex-col'>
    <div>
    ...
    <div className=' relative'>
        ...
        <div className="flex justify-end gap-2 mt-3"><button className="flex items-center bg-green-700 cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-white undefined" type="submit">Save</button></div>
