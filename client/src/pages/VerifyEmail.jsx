...
const VerifyEmail = () => {
    ...
    const handleOnSubmit=(e)=>{
            ...
            dispatch(signUp(accountType,firstName,lastName,phone,email,password,confirmPassword,otp,navigate))
    }
  return (
  ...
  renderInput={(props, index) => (
    <input
      {...props}
      className='p-4 bg-green-400 w-1/4 rounded-lg' 
      style={{ color: otp[index] ? 'black' : 'white' }}
    />
  )}
/>
